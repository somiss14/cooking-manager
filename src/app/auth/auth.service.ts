...
export class AuthService {
  ...
  login(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB7p7IbCEAn24YMVrAJqM7IipJFI3SyLbQ',
      {
        email: email,
        password: password,
        returnSecureToken: true
